...
void Update_PD_Plots(void)
{
	...
	{															   
		...
		{
			UpdateSG1();
			PlotXY (mainpnl, MAINPNL_SIG1GRAPH, peak_position, peak_ampl, pd_peak_cnt, VAL_DOUBLE, VAL_DOUBLE, VAL_SCATTER, VAL_SOLID_CIRCLE, VAL_SOLID, 1, VAL_BLACK);
		}
		...
		{
			UpdateSG2();
			PlotXY (mainpnl, MAINPNL_SIG2GRAPH, peak_position, peak_ampl, pd_peak_cnt, VAL_DOUBLE, VAL_DOUBLE, VAL_SCATTER, VAL_SOLID_CIRCLE, VAL_SOLID, 1, VAL_BLACK);
		}
		...
		{
			UpdateSG3();
			PlotXY (mainpnl, MAINPNL_SIG3GRAPH, peak_position, peak_ampl, pd_peak_cnt, VAL_DOUBLE, VAL_DOUBLE, VAL_SCATTER, VAL_SOLID_CIRCLE, VAL_SOLID, 1, VAL_BLACK);
		}
		...
		{
			UpdateSG4();
			PlotXY (mainpnl, MAINPNL_SIG4GRAPH, peak_position, peak_ampl, pd_peak_cnt, VAL_DOUBLE, VAL_DOUBLE, VAL_SCATTER, VAL_SOLID_CIRCLE, VAL_SOLID, 1, VAL_BLACK);
		}
