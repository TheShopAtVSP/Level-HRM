...
// DFU_REGION_TOTAL_SIZE			0x0007A000 - (SD_SIZE_GET(MBR_SIZE)(0x1000) = 0x1C000)=0x5E000
#ifndef DFU_APP_DATA_RESERVED
#define DFU_APP_DATA_RESERVED           CODE_PAGE_SIZE * 0x0000                                         /**< Size of Application Data that must be preserved between application updates. This value must be a multiple of page size. Page size is 0x400 (1024d) bytes, thus this value must be 0x0000, 0x0400, 0x0800, 0x0C00, 0x1000, etc. */
// DFU_APP_DATA_RESERVED           	0x0000 (0k)                                         				/**< Size of Application Data that must be preserved between application updates. This value must be a multiple of page size. Page size is 0x400 (1024d) bytes, thus this value must be 0x0000, 0x0400, 0x0800, 0x0C00, 0x1000, etc. */
#endif
...
// DFU_IMAGE_MAX_SIZE_FULL			0x5E000 - 0x0000 = 0x5E000 (385k)                                         
...
// DFU_IMAGE_MAX_SIZE_BANKED		0x5E000 - ( 0x5E000 % (2 * 0x0000))) / 2 = (0x5E000 - 0x0000)/2 = 0x2F000 (192512dec)
...
// DFU_BL_IMAGE_MAX_SIZE			0x0007F000 - 0x0007A000 = 0x5000 (20480dec)
#define DFU_BANK_0_REGION_START         CODE_REGION_1_START                                             /**< Bank 0 region start. */
// DFU_BANK_0_REGION_START			SD_SIZE_GET(MBR_SIZE)(0x1000) = 0x1C000
#define DFU_BANK_1_REGION_START         (DFU_BANK_0_REGION_START + DFU_IMAGE_MAX_SIZE_BANKED)           /**< Bank 1 region start. */
// DFU_BANK_1_REGION_START			0x1C000 + 0x2F000 = 0x4B000 

/* MEM MAP	(CODE_PAGE_SIZE 0x1000, DFU_APP_DATA_RESERVED 0x4000, MBR 0x1000, SD_SIZE_GET(MBR_SIZE)(MBR_SIZE = 0x1000) = 0x1C000)

0x00000000	0x0001C000		SD132

0x0001C000					DFU_BANK_0_REGION_START 

0x0004B000					DFU_BANK_1_REGION_START

0x0007A000					BOOTLOADER_REGION_START

0x0007E000					BOOTLOADER_MBR_PARAMS_PAGE_ADDRESS

0x0007F000					BOOTLOADER_SETTINGS_ADDRESS
