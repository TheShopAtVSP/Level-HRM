...
#include <stdint.h>
#include "dfu_types.h"	//include definition for BOOTLOADER_SETTINGS_ADDRESS
...
typedef struct
{
	...
	uint32_t               bl_rev;			/**< Bootloader Version Number. Used by Application Code to inform User of BL Version */
