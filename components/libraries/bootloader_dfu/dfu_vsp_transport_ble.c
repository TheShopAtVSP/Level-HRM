...
#define ADVERTISING_LED_PIN_NO               GRN_LED                                               /**< Is on when device is advertising. */
#define CONNECTED_LED_PIN_NO                 BLU_LED                                               /**< Is on when device has connected. */
...
#define DEVICE_NAME                          "AwareDFU"                                               /**< Name of device. Will be included in the advertising data. */
