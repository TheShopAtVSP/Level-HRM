...
#define DFU_REV_MAJOR                        0x01                                                    /** DFU Major revision number to be exposed. */
#define DFU_REV_MINOR                        0x02                                                    /** DFU Minor revision number to be exposed. */
...
#define DEVICE_NAME                          "LevelDFU"                                              /**< Name of device. Will be included in the advertising data. */
...
extern app_timer_id_t g_TIMEOUT_timer_id;

/**@brief     Function for retrieving the Bootloader Revision
 *
 * @details   Bah!
 *
 * @retval    uint32_t 
...
static void on_dfu_evt(ble_dfu_t * p_dfu, ble_dfu_evt_t * p_evt)
{
    ...
    switch (p_evt->ble_dfu_evt_type)
    {
        ...
        case BLE_DFU_RECEIVE_INIT_DATA:
			...
			// stop the timer
			app_timer_stop(g_TIMEOUT_timer_id);
