...
/**@brief Thought it'd be nice to know... a concept that apparently elludes those of the Nordic persuasion:
 *
 * @param[in]  timer_id					Timer identifier.
 *
 * @retval     0   						Timer not defined
 * @retval     1						Timer recognized
 */
bool app_timer_is_valid(app_timer_id_t timer_id);
