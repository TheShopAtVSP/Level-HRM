 ...
 *		 DEVICE_MANAGER_MAX_BONDS changed to 1 from 7 for single device bonding WMM
 */
 ...
 *          Dependencies  : None.
 */
#define DM_GATT_CCCD_COUNT               8		//sd_ble_gatts_sys_attr_get() would return Error when = 2
