...
#define  MAINPNL_HRM_7SEG_8               100     /* control type: numeric, callback function: (none) */
#define  MAINPNL_HRM_7SEG_7               101     /* control type: numeric, callback function: (none) */
#define  MAINPNL_HRM_7SEG_6               102     /* control type: numeric, callback function: (none) */
#define  MAINPNL_HRM_7SEG_4               103     /* control type: numeric, callback function: (none) */
#define  MAINPNL_HRM_7SEG                 104     /* control type: numeric, callback function: (none) */
#define  MAINPNL_RT_TIMER                 105     /* control type: timer, callback function: RT_Timer_CB */
#define  MAINPNL_PHASE2SF                 106     /* control type: numeric, callback function: Phase2ScaleFactor */
#define  MAINPNL_AUTO_P2SF                107     /* control type: textButton, callback function: Phase2ScaleFactor */
#define  MAINPNL_SQRB                     108     /* control type: textButton, callback function: Sqr_B */
#define  MAINPNL_SQRA                     109     /* control type: textButton, callback function: Sqr_A */
#define  MAINPNL_LED_C_I                  110     /* control type: ring, callback function: LED_C_Current */
#define  MAINPNL_LED_B_I                  111     /* control type: ring, callback function: LED_B_Current */
#define  MAINPNL_LED_A_I                  112     /* control type: ring, callback function: LED_A_Current */
#define  MAINPNL_CH2_LEDA_EN              113     /* control type: radioButton, callback function: Chan_2_LED_Enable */
#define  MAINPNL_CH2_LEDC_EN              114     /* control type: radioButton, callback function: Chan_2_LED_Enable */
#define  MAINPNL_CH2_LEDB_EN              115     /* control type: radioButton, callback function: Chan_2_LED_Enable */
#define  MAINPNL_CH1_LEDC_EN              116     /* control type: radioButton, callback function: Chan_1_LED_Enable */
#define  MAINPNL_CH1_LEDB_EN              117     /* control type: radioButton, callback function: Chan_1_LED_Enable */
#define  MAINPNL_CH1_LEDA_EN              118     /* control type: radioButton, callback function: Chan_1_LED_Enable */
#define  MAINPNL_GLASSESONMSG             119     /* control type: textMsg, callback function: (none) */
#define  MAINPNL_SIG1GRAPH                120     /* control type: strip, callback function: Accel_and_Gyro_Cursor_Update */
#define  MAINPNL_HRM_DAY_GRAPH            121     /* control type: graph, callback function: (none) */
#define  MAINPNL_DECORATION_15            122     /* control type: deco, callback function: (none) */
#define  MAINPNL_SG_FS                    123     /* control type: numeric, callback function: Apply_Raw_Data_Filtering_CB */
#define  MAINPNL_SG_PO                    124     /* control type: numeric, callback function: Apply_Raw_Data_Filtering_CB */
#define  MAINPNL_RESTART_FO               125     /* control type: command, callback function: ReStart_FO */
#define  MAINPNL_CLR_SCART                126     /* control type: command, callback function: ClearStripChartCB */
#define  MAINPNL_ONE_SHOT                 127     /* control type: radioButton, callback function: (none) */
#define  MAINPNL_MISS                     128     /* control type: numeric, callback function: (none) */
#define  MAINPNL_HIT                      129     /* control type: numeric, callback function: (none) */
#define  MAINPNL_DECORATION_19            130     /* control type: deco, callback function: (none) */
#define  MAINPNL_PD_EMI_WIDTH             131     /* control type: numeric, callback function: Apply_Raw_Data_Filtering_CB */
#define  MAINPNL_DECORATION_2             132     /* control type: deco, callback function: (none) */
