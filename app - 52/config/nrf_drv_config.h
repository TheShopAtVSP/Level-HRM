...
#define SPI1_CONFIG_SCK_PIN         SPI_SCK_PIN 
#define SPI1_CONFIG_MOSI_PIN        SPI_MOSI_PIN
#define SPI1_CONFIG_MISO_PIN        SPI_MISO_PIN
...
#if (WDT_ENABLED == 1)
#define WDT_CONFIG_BEHAVIOUR     NRF_WDT_BEHAVIOUR_RUN_SLEEP_HALT
